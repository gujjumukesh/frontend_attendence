    ...
    const fetchAttendance = async () => {
      ...
      try {
        ...
        if (records.length > 0) {
          ...
          // Dynamic percentage against actual recorded days
          const totalDays = presentCount + absentCount;
          const percentage = totalDays > 0 ? (presentCount / totalDays) * 100 : 0;
          
          setMetrics({ present: presentCount, absent: absentCount, holidays: holidayCount, workingDays: totalDays });
          ...
          <motion.div whileHover={{ y: -5 }} className="md:col-span-2">
            <Card className="h-full bg-gradient-to-br from-indigo-500 to-purple-600 border-none text-white shadow-lg overflow-hidden relative">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-white/70">Calculated based on recorded total active attendance days</CardDescription>
              </CardHeader>
              <CardContent>
